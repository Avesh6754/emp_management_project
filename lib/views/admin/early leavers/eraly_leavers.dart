                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ((emp_provider_true.oneDateEmpList[index].date==DateFormat("dd").format(selectedDate) &&(emp_provider_true.oneDateEmpList[index].attendanceTime=='Early')))?ListTile(
                          title: Text(
